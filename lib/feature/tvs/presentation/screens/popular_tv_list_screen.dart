...
class PopularTvListScreen extends StatelessWidget {
  const PopularTvListScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) =>
          sl<TvListBloc>()..add(GetPopularTvListEvent()),
      child: Scaffold(
        appBar: AppBar(
          title: Text(
            'Popular Tvs',
        ...
        body: BlocBuilder<TvListBloc, TvListState>(
          buildWhen: (previous, current) =>
              previous.popularTvListState != current.popularTvListState,
          builder: (context, state) {
            switch (state.popularTvListState) {
